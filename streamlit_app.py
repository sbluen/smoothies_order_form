...
for fruit in ingredients_list:
    ...
    df_smoothiefruit = pd.DataFrame(smoothiefroot_response.json())['nutrition']
    #st.dataframe(data=df_smoothiefruit, use_container_width=True)
    st.write(str(df_smoothiefruit).replace('\n', '  \n'))
